...
class LogSumExp(TensorOp):
    ...
    def compute(self, Z):
        ...
        return array_api.log(array_api.sum(array_api.exp(Z - z_max_origindim), self.axes)) + z_max_reducedim
        ### END YOUR SOLUTION
    ...
    def gradient(self, out_grad, node):
        ...
        exp_z = array_api.exp(z.realize_cached_data() - max_z)
        sum_exp_z = array_api.sum(exp_z, self.axes)
